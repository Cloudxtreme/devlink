/*
 *   libmnlg.c - Generic Netlink helpers for libmnl
...
#define MNLG_EXPORT __attribute__ ((visibility("default")))
...
struct nlmsghdr *__mnlg_msg_prepare(struct mnlg_socket *nlg, uint8_t cmd,
